...
export default function SideBar() {
  return (
    <motion.aside
      ...
      className="w-72 h-screen fixed top-0 left-0 p-6 border-r-4 border-b-4 transition-transform duration-500 hover:scale-105"
      style={{
    ...
    >
      <div
        className="w-50 h-50 rounded-full overflow-hidden border-4 mb-8"
        style={{
      ...
      <div className="mb-6">
        ...
        <ul className="text-sm font-light list-disc list-inside space-y-1">
          <li><Link href="https://github.com/YoelK20" target="_blank" className="hover:underline">Github</Link></li>
          <li><Link href="https://www.linkedin.com/in/yoel-kristiadi-975053310/" target="_blank" className="hover:underline">LinkedIn</Link></li>
          <li><Link href="https://www.facebook.com/yoel.kristiadi.9" target="_blank" className="hover:underline">Facebook</Link></li>
          <li><Link href="https://wa.me/628117011200" target="_blank" className="hover:underline">WhatsApp</Link></li>
        </ul>
      </div>
